...
function draw() {
  ...
  if (gameState === START) {
    ...
    fill("black");
    textSize(40)
    text("Press 'S' Key To Start The Game", 350, 250)
  ...
  if (gameState === PLAY) {
    ...
    text("BANANA SCORE: " + bananaScore, 500, 80);
    if (bg.x < 600) {
      bg.x = bg.width / 2;
    }
...
function banana() {
  if (frameCount % 130 === 0) {
    var banana = createSprite(1600, Math.round(random(170, 290)), 20, 20)
...
function stone() {
  if (frameCount % 150 === 0) {
    var stone = createSprite(1600, Math.round(random(350, 390)), 20, 20);
    Math.round(random())
...
function stone1() {
  if (frameCount % 300 === 0) {
    var stone1 = createSprite(1600, Math.round(random(350, 390)), 20, 20);
